...
<div class="product-grid">
  ...
  <div class="product-card">
    <div class="product-thumb">
      <img src="/img/mesh/rook/rook_v4_assembled_4x3.jpg" alt="Rook v4 low-power LoRa board" />
    </div>
    <div class="product-body">
      <span class="badge-tag">Board</span>
      <h3>Rook v4</h3>
      <div class="product-price">from $10.00</div>
      <p class="product-desc">
        Our small, low-power LoRa board for battery-powered mesh nodes and remote
        sensors. Available assembled and flashed with MeshCore, or as a bare PCB.
      </p>
      <a href="/shop/rook-v4/" class="learn-more-link">Learn more</a>
    </div>
  </div>

  <div class="product-card">
    <div class="product-thumb">
      <img src="/img/mesh/bric/sensor_package_listing_4x3.png" alt="Mesh Radio Water Level Kit: enclosure, solar panel, ultrasonic sensor, and battery" />
    </div>
    <div class="product-body">
      <span class="badge-tag">Kit</span>
