...
Because such carbon filters only have a limited capacity for adbsoprtion, they must be replaced after a certain amount of use.  Their cost is not trivial; so a household or small community using such filters for their drinking water will incur an ongoing cost.

Also, traditional methods for producing activated carbon typically rely on sophisticated industrial chemical processes and fossil fuel-based inputs.
