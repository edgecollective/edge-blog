...
This necessary engineering pedagogy will, however, be empty, pointless -- and will fail its students -- if it is not accompanied by socio-economic analyses that offer some explanation for the origins of our current predicament, as well as by promising alternative economic models that offer some hope of a different, better path forward. Without a new economic framework and set of values -- something other than 'maximum profit' and 'maximum business growth' -- any engineering skills learned or projects undertaken by today's students will almost certianly end up contributing to, rather than redressing, our growing climate crisis. 

Without an economic critique, and without being presented with any positive alternatives, students will certainly resign themselves to the idea that 'there is no alternative', and go on to reproduce the system as it has been.  If we allow this to happen, they -- and we -- will suffer; it is a certainty that the system as it has been -- one that demands exponential economic growth -- cannot continue, whether or not we adapt or change our ways.  To avoid this truth in our teaching, and attempt to remain agnostic with respect to the economics that our students will practice, is not just to fail them, but also to abandon our own hopes for a not-terrible future.
